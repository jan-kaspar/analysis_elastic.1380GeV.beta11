...
draw(RootGetObject(f, dir+"/horizontal/horizontal graph fit/horizontal fit|merged"), "p", heavygreen);
draw(RootGetObject(f, dir+"/horizontal/horizontal profile/p"), "eb,d0", red+1pt);
draw(RootGetObject(f, dir+"/horizontal/horizontal profile/p|ff"), blue+1pt);
...
draw(RootGetObject(f, dir+"/vertical/y_hist"), "vl", red);
