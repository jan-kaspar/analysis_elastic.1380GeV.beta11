...
void Environment::UseMatchedOptics()
{
	...
	*/
	...
	printf("\tmatched optics sent by Frici on 25 August 2016\n");
	v_x_L_N = -3.26564444816241;		v_x_R_N = -3.31266484799046;		// 1
	v_x_L_F = -2.99950462376314;		v_x_R_F = -3.05445175972783;		// 1
	dvds_x_L = 0.0496750317851944E-3;	dvds_x_R = 0.0481564432381383E-3;	// mm^-1

	L_x_L_N = 6.86972466495647E3;		L_x_R_N = 7.61556939360727E3;		// mm
	L_x_L_F = 4.66927958123825E3;		L_x_R_F = 5.4033338559527E3;		// mm
	dLds_x_L = -0.410713352360469;		dLds_x_R = -0.412579377038876;		// 1

	v_y_L_N = -3.08472382444756;		v_y_R_N = -3.04638583984266;		// 1
	v_y_L_F = -3.33754431850176;		v_y_R_F = -3.28722977142462;		// 1
	dvds_y_L = -0.0471889771485095E-3;	dvds_y_R = -0.0449171156832989E-3;	// mm^-1

	L_y_L_N = 20.964339389662E3;		L_y_R_N = 18.4050213930398E3;		// mm
	L_y_L_F = 20.9457479984901E3;		L_y_R_F = 18.0999984812449E3;		// mm
	dLds_y_L = -0.00347008550901296;	dLds_y_R = -0.0568864215300219;		// 1
